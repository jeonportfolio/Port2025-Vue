                ...
                <div>
                        ...
                        <div>
                            ...
                            <p > <h4 >★나의 유튜브 영상 저장 사이트</h4><br/>
                                  ...
                                  <span className="fixed">▶JavaScript에서 동적 타입으로 인한 오류 발생 가능성과 코드 유지보수의 어려움을 느껴 정적 타입을 지원하는 TypeScript로 리팩토링을 수행하여 코드의 안정성과 가독성 향상</span><br/><br/>
                                  ...
                                  → 진행기간(2024.12.22 ~ 2025.01.05) <br/><br/>
                                  ...
                                  <span className="fixed">▶Redux Toolkit의 createslice를 활용하여 효율적인 전역 상태 관리</span><br/><br/>
                                  <span className="fixed">▶Vitest를 활용한 각 액션과 API Mock 테스트를 통해 안정성 보장 </span><br/><br/>                                
                                  <span className="fixed">▶Firebase 환경 설정 후 배포</span><br/><br/>
                                  <br/><br/>

                                  <h4 >★여행 계획 사이트</h4><br/>
                                  → 국내, 국외 여행지의 일정에 따라 명소와 숙소까지 손쉽게 계획할 수 있도록 도와주는 사이트입니다. <br/><br/>
                                  → 진행기간(2025.03.10 ~ 2025.06.05) <br/><br/>
                                  <span className="fixed">▶nedb(데이터베이스)를 사용 클라이언트와 서버로 나누어 진행 </span><br/><br/>
                                  <span className="fixed">▶zustand를 활용하여 전역 상태 관리</span><br/><br/>
                                  <span className="fixed">▶Google Maps API 사용해 지도의 다양한 기능 사용</span><br/><br/>
                                  <span className="fixed">▶Cypress를 통한 E2E테스트 진행 userflow관점에서 결함 최소화 및 내부 API 개선 </span><br/>                                  
